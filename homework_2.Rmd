...
This problem uses [data](data/gbb_datasets.zip) on elements of the [Great British Bake Off](https://thegreatbritishbakeoff.co.uk). The show has been running for 10 seasons; in each episode, contestants compete in signature challenges, technical challenges, and a showstopper. At the end of an episode the winner is crowned "Star Baker" (and winner in the last episode of a season), and a loser is eliminated. 
