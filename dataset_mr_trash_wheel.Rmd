...
The version of the Mr. Trash Wheel data we'll use for this class is available  [here](./data/202207 Trash Wheel Collection Data.xlsx).

**_UPDATE: A new version of the trash wheel data is [here](data/202309 Trash Wheel Collection Data.xlsx)._**
...
Data collected by Mr. Trash Wheel is publicly available as a .xlsx document.
