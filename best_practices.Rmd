...
Create a directory and save the previous two scripts into that directory. Script names, like variable names, should be descriptive (e.g. `20230905_var_assign.R` and `20230905_simple_plots.R`). The directory name should be descriptive as well, and it should be in a reasonable place on your computer (e.g. `~/Documents/first_project/`). Create an R Project using File > New Project > Existing Directory and specifying the directory you just created.
