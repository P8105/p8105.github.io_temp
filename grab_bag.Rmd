...
We'll revisit some examples from the course, and also take a look at the data in this [zip file](jury_data.zip) (described [here](https://github.com/APM-Reports/jury-data)). 
