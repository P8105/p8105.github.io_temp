...
This [zip file](data/citibike.zip) contains data on rides taken on the NYC Citi Bike system. Files contain 1% of all rides with a total duration less than 4 hours in each of four months. Import, clean, and tidy these data, and describe the resulting dataset. 
...
If you'd like, you can complete [this short survey](https://forms.gle/3BVcBA1ix91oc4Mk9) after you've finished the assignment.
